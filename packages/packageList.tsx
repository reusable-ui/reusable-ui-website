...
export const navItem                = new ComponentInfo('navItem')
export const navscroll              = new ComponentInfo('navscroll')
export const pagination             = new ComponentInfo('pagination')
export const accordion              = new ComponentInfo('accordion')
export const accordionItem          = new ComponentInfo('accordionItem')
