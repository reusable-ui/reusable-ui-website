...
const EditableControlPage: NextPage = () => {
    return (<ComponentContextProvider component={editableControl} baseComponents={control}>
        <Head>
            ...
            <meta name="description" content={`${editableControl.componentTag} is a clickable simple box layout component with built-in variants, states, and ${packages.clickable.packageShortName}.`} />
        </Head>
...
import {editableControls, editableControlValues} from '@reusable-ui/action-control';
