                ...
                <Accordion theme='primary'>
                    <PackageItem package={packages.modal}>
                        <p>
                            ...
                            You need to place <code>{'<YourComponent>'}</code> inside the {packages.modal.packageLink} in order to make an interactive UI.
                        </p>
                    </PackageItem>
            ...
            <Section title='Composite Components'>
                ...
                <Accordion theme='primary'>
                    ...
                    <PackageItem package={packages.nav}>
                        <p>
                            A list of client-side navigation with automatically toggling-on the {packages.navItem.packageDisplay}&apos;s {packages.activatable.packageShortLink} at correspoding <em>url</em>.
                        </p>
                    </PackageItem>
